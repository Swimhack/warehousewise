...
export const createSampleData = async () => {
  try {
    ...
    const locations = [
      ...
      { name: "DOCK-02", type: "dock" as const, capacity: 100, is_active: true },
      { name: "A1-01", type: "shelf" as const, capacity: 50, is_active: true },
      { name: "A1-02", type: "shelf" as const, capacity: 50, is_active: true },
      { name: "A1-03", type: "shelf" as const, capacity: 50, is_active: true },
      { name: "A2-01", type: "shelf" as const, capacity: 50, is_active: true },
      { name: "A2-02", type: "shelf" as const, capacity: 50, is_active: true },
      { name: "B1-01", type: "bin" as const, capacity: 25, is_active: true },
      { name: "B1-02", type: "bin" as const, capacity: 25, is_active: true },
      { name: "B1-03", type: "bin" as const, capacity: 25, is_active: true },
      { name: "B2-01", type: "bin" as const, capacity: 25, is_active: true },
      { name: "B2-02", type: "bin" as const, capacity: 25, is_active: true },
      { name: "STAGING-01", type: "staging" as const, capacity: 200, is_active: true },
      { name: "STAGING-02", type: "staging" as const, capacity: 200, is_active: true },
      { name: "QUARANTINE-01", type: "quarantine" as const, capacity: 30, is_active: true },
    ];
